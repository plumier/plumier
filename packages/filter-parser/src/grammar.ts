...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "string_range$string$1", "symbols": [{"literal":"."}, {"literal":"."}, {"literal":"."}], "postprocess": (d) => d.join('')},
    {"name": "string_range", "symbols": ["string", "_", "string_range$string$1", "_", "string"], "postprocess": (d, c) => literal("String", [d[0].value, d[4].value], c, "range")},
    {"name": "string_range$string$2", "symbols": [{"literal":"."}, {"literal":"."}, {"literal":"."}], "postprocess": (d) => d.join('')},
    {"name": "string_range", "symbols": ["number", "_", "string_range$string$2", "_", "number"], "postprocess": (d, c) => literal("Number", [d[0].value, d[4].value], c, "range")},
