...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "starts_with", "symbols": ["quote", "starts_with$ebnf$1", {"literal":"*"}, "quote"], "postprocess": d => ({ value: join(d[1]) })},
    {"name": "ends_with$ebnf$1", "symbols": [/./]},
    {"name": "ends_with$ebnf$1", "symbols": ["ends_with$ebnf$1", /./], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "ends_with", "symbols": ["quote", {"literal":"*"}, "ends_with$ebnf$1", "quote"], "postprocess": d => ({ value: join(d[2]) })},
