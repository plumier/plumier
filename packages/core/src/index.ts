...
export { GenericController, GenericOneToManyController, IdentifierResult, createRoutesFromEntities, crud, OneToManyDecorator, Repository, OneToManyRepository } from "./generic-controller"
