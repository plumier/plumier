...
A reflection library that extracts TypeScript or JavaScript object (type, function, module etc) into an object graph containing object preferences and metadata information
