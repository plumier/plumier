...
* `ActionRoute` is a kind of route that handled by controller, this route will have Controller and Action metadata information that further executed by Action Invocation, and the Open API Specification can be automatically generated by Swagger.
